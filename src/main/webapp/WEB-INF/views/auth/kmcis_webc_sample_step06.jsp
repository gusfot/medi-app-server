...
* File Name     : kmcis_webc_sample_step06.jsp
* Comment       :
* History       :
**************************************************************************************************************************/
%>
...
<%
		...
		***********************************************************************************************************/
		...
		String enc_tr_cert = "";
		tr_cert     = certNum +"/"+ check_1 +"/"+ check_2 +"/"+ check_3 +"/"+ extendVar;
        ...
        String send_url = "https://www.kmcert.com/kmcis/webc_CI/kmcisSmsRetryProc.jsp?tr_cert="+tr_cert;
