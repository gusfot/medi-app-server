...
<html>
    ...
    <body bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            <br><br><br>
            <span class="style1">본인인증서비스(웹통신방식) 테스트 - SMS재전송 요청</span><br>

            <form name="reqForm" method="post" action="./auth6">
                ...
                <br><br>
                <input type="submit" value="SMS재전송 확인" />
            </form>
