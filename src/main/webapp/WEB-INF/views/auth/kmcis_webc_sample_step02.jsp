...
/**************************************************************************************************************************
* Service Name  : ICERT
* Program Name  : 본인인증서비스(웹통신CI방식) 샘플 페이지 (암/복호화, 통신)
* File Name     : kmcis_webc_sample_step02.jsp
* Comment       :
* History       :
**************************************************************************************************************************/
%>
...
<%
        ...
        String nation		= request.getParameter("nation");		//내국인
		...
		***********************************************************************************************************/
		...
		String enc_tr_cert = "";
		tr_cert     = cpId +"/"+ urlCode +"/"+ certNum +"/"+ date +"/"+ phoneNo +"/"+ phoneCorp +"/"+ birthDay +"/"+ gender +"/"+ nation +"/"+ name +"/"+ extendVar;
...
%>
            ...
            <table cellpadding=1 cellspacing=1>
                ...
                <tr>
                    ...
                    <td align=left><%=r_date%></td>
                </tr>
                <tr>
					<td align=left>이용자성명</td>
					<td align=left><%=r_name%></td>
				</tr>
				<tr>
					<td align=left>휴대폰번호</td>
					<td align=left><%=r_phoneNo%></td>
				</tr>
				<tr>
					<td align=left>이동통신사</td>
					<td align=left><%=r_phoneCorp%></td>
				</tr>
				<tr>
					<td align=left>생년월일</td>
					<td align=left><%=r_birthDay%></td>
				</tr>
				<tr>
					<td align=left>이용자성별</td>
					<td align=left><%=r_gender%></td>
				</tr>
				<tr>
					<td align=left>내외국인</td>
					<td align=left><%=r_nation%></td>
				</tr>
                <tr>
